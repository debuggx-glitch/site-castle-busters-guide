...
export default function Home(){return <main className="war-room">
  <HomeAd/>
  <div className="home-hero-shell"><section className="royal-hero"><div className="hero-copy"><p className="overline">The independent command table</p><h1>Hold the line.<br/><span>Build the right crew.</span></h1><p>{site.description}</p><Link className="battle-button" href={`/guides/${guides[0].slug}/`}>Open the field manual</Link></div><figure><Image src={site.visual} width={site.visualWidth} height={site.visualHeight} sizes="(max-width: 820px) 100vw, 50vw" priority alt={site.visualAlt}/><figcaption>Official game image · verify live balance before committing resources</figcaption></figure></section><HomeSideAd/></div>
